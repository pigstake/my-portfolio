      ...
      <main>
        ...
        <article className='work'>
          ...
          <section className='work-copy'>
            ...
            <p>coming soon</p>
            <p><a href='https://photos.app.goo.gl/tB0XEWOTu3P9NpKT2'>See photos and screenshots of my process</a></p>
            <p><a href='https://vitalcard.com'>Visit the site</a></p>
          </section>
        </article>
        <article className='work'>
          <section className='work-copy'>
          ...
          <section className='work-copy'>
            ...
            <figure>
              <a className='img-link' href='https://photos.app.goo.gl/n0ehciw4TowBNx6t2'>
          ...
          <section className='work-copy'>
            ...
            <p><a href='https://photos.app.goo.gl/n0ehciw4TowBNx6t2'>See more portfolio photos</a></p>
          </section>
        </article>
        <article className='work'>
          <section className='work-copy'>
          ...
          <section className='work-copy'>
            ...
            <figure>
              <a className='img-link' href='https://photos.app.goo.gl/ZhBl9yCMAExw48XK2'>
            ...
            <p>For more images of my process and output: <a href='https://photos.app.goo.gl/ZhBl9yCMAExw48XK2'>Dig into the work</a></p>
          </section>
        </article>
        <article className='work'>
          <section className='work-copy'>
          ...
          <section className='work-copy'>
            ...
            <figure>
              <a className='img-link' href='https://photos.app.goo.gl/8Jev2yZ7k55ZUty13'>
            ...
            <p>For more images of my process and output: <a href='https://photos.app.goo.gl/8Jev2yZ7k55ZUty13'>See more behind the scenes and screens</a></p>
          </section>
        </article>
        <article className='work'>
          <section className='work-copy'>
          ...
          <section className='work-copy'>
            ...
            <figure>
              <a className='img-link' href='https://photos.app.goo.gl/E0qiUXvqx7Zej9zT2'>
            ...
            <h3>The impact I made</h3>
            <p>This is not a software startup; it’s a pizza restaurant. <a href='https://techcrunch.com/2016/11/29/every-company-is-a-technology-company-but-most-dont-behave-like-one/'>All companies might be software companies</a> in the future. I helped the founder see value in digital extensions of his service, and the work it takes to build the right things — teaching and working alongside him with design collaboration, agile implementation planning, and some favorite tools like Slack, Invision and Trello. You can see the two of us in the middle of a design studio in the above photo.</p>
            <p>For more photos of my process and output for Baker’s Pizza: <a href='https://photos.app.goo.gl/E0qiUXvqx7Zej9zT2'>Flip through project photos</a></p>
          </section>
        </article>
        <article className='work'>
          <section className='work-copy'>
            ...
            <p>
              <a href='https://venmetro.com'>venmetro.com</a> &rarr; $2,300,000 lent so far!
