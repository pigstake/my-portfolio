    ...
    return (
      <main>
        <header className='hero'>
          <p className='subtitle'>Hi, I’m <a href='#aboutMe'>Jamie.</a> I’ve been designing (mostly for screens) since 2010 — leading startups through research and strategy, finding joy in craft and code, and mentoring peers and newbies. Below you’ll find snippets and stories of my work. Find more on <a href='https://twitter.com/pigstake'>Twitter</a>, <a href="https://medium.com/@pigstake">Medium</a>, and <a href="https://www.linkedin.com/in/jamisoncaloras/">LinkedIn</a>.</p>
        </header>
        <article className='work'>
          <section className='work-copy'>
            <h4>Recent Work Snippets</h4>
            <div className='work-snippet'>
              <h3>Teachers Pay Teachers</h3>
              <h5>**something something** <br /> <a href='https://www.teacherspayteachers.com/TpTSchoolAccess/Teachers'>Visit School Access</a></h5>
              <p>T</p>
            </div>
            <div className='work-snippet'>
              <h3>Guai Goods</h3>
